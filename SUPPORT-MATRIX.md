...
The v1.1.0 parent Skill uses independent Director, fresh chapter creators and
independent visual review, with focused task files and per-shot rendering.
Both standard Skills and full environment archives contain this same workflow.
The v1.0.1 archives and the earlier evidence above remain available as history;
existing users install v1.1.0 to update.
